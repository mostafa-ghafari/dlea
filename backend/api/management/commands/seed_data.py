...
def seed_achievements():
    data = [
        ...
        ("۱۰۰ معامله ثبتشده", "قهرمان ژورالنویسی.", True, "شمارش کل معاملات ثبتشده (دستی + متاتریدر) در ماه جاری ≥ ۱۰۰."),
        ("Profit Factor بالای ۲", "استراتژی سودده اثباتشده.", False, "مجموع سود ناخالص ÷ قدرمطلق مجموع زیان ناخالص > ۲ با حداقل ۲۰ معامله."),
        ("بدون ورود احساسی در ۳۰ روز", "روانشناسی طلایی.", False, "هیچ معاملهای با برچسب احساس در گروه (طمع، ترس، انتقام) ثبت نشده باشد."),
        ("اولین معامله ثبتشده", "سفرت را شروع کردی.", True, "حداقل یک معامله در ماه جاری ثبت شده باشد."),
        ("۳۰ روز متوالی ژورالنویسی", "عادت طلایی ساخته شد.", True, "برای ۳۰ روز تقویمی متوالی حداقل یک ورودی ژورنال ثبت شده باشد."),
        ...
        ("۱۰ معامله A+ متوالی", "فقط ستآپهای تمیز.", False, "۱۰ معامله متوالی با چکلیست کامل و R:R ثبتشده ≥ ۲."),
        ("اتصال موفق متاتریدر", "همگامسازی خودکار فعال شد.", True, "حداقل یک پرتفولیو با وضعیت اتصال فعال به MT4/MT5."),
        ("استاد چکلیست", "۵۰ چکلیست کامل قبل از ورود.", False, "۵۰ چکلیست پیش از معامله با همه آیتمهای تیکخورده در ماه جاری."),
    ]
    ...
    AchievementHistory.objects.create(
        ...
        earned=["۷ روز پایبند به پلن", "۱۰۰ معامله ثبتشده", "ماه سودده", "اولین معامله ثبتشده", "اتصال موفق متاتریدر", "Win Rate بالای ۷۰٪", "ریسک زیر ۱٪ در ۵۰ معامله", "۳۰ روز متوالی ژورالنویسی", "Profit Factor بالای ۲"],
    )
    AchievementHistory.objects.create(
        month="شهریور ۱۴۰۳", count=5,
        earned=["اولین معامله ثبتشده", "اتصال موفق متاتریدر", "۷ روز پایبند به پلن", "ماه سودده", "کاهش دراودان ۵٪"],
    )
    AchievementHistory.objects.create(month="مرداد ۱۴۰۳", count=2, earned=["اولین معامله ثبتشده", "اتصال موفق متاتریدر"])


def seed_plans():
    plans = [
        dict(slug="free", name="رایگان", price="۰", unit="تومان", tagline="برای شروع ژورالنویسی",
