        ...
        <div className="mx-auto max-w-7xl px-4 py-24 md:px-8 md:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              معاملات، احساسات و اشتباهات خود را ثبت کنید. هوش مصنوعی مثل یک
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-xs text-muted-foreground">
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 gain" /> بدون نیاز به کارت
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 gain" /> اتصال MT4/MT5
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 gain" /> کاملاً فارسی
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              هرآنچه یک معامله‌گر حرفه‌ای نیاز دارد
            </h2>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {[
              ...
              >
                <div className="text-5xl font-bold text-primary/20 tabular">
                  {s.num}
                </div>
            ...
            {plans.map((p) => (
              ...
              >
                ...
                <div className="mt-6 flex flex-wrap items-baseline gap-x-2 gap-y-1">
                  <span className="text-3xl font-bold tabular md:text-4xl">
                    {p.price}
                  </span>
      ...
      >
        <div className="mx-auto max-w-3xl px-4 md:px-8">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              پرسش‌های رایج معامله‌گران
            </h2>
            <p className="mt-4 text-muted-foreground">
              هرچه لازم است قبل از شروع بدانید.
            </p>
          </div>
