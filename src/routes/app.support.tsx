  ...
  head: () => ({
    meta: [
      { title: "پشتیبانی و تیکت‌ها | Dlea AI" },
      {
        name: "description",
        content:
          "ارسال تیکت پشتیبانی فنی، پرداخت و اشتراک و پیگیری تاریخچه گفتگو با تیم پشتیبانی.",
      },
...
function SupportPage() {
  ...
  const mine = tickets.filter(
    (t) => !currentUser || t.email === currentUser.email,
  );
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              موضوع را انتخاب و مشکل را با جزئیات توضیح بده.
            </DialogDescription>
          </DialogHeader>
          <div className="mt-4 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={topic}
                onValueChange={(v) => setTopic(v as TicketTopic)}
              >
          ...
          {active ? (
            <div className="card-surface flex h-full flex-col p-6">
              <div className="flex flex-wrap items-center gap-2 border-b border-border pb-4">
                ...
                <Badge variant="outline" className={statusClass(active.status)}>
                  {active.status}
                </Badge>
