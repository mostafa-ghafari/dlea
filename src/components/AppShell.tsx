...
export function AppShell({
  ...
  const locked =
    ...
    onboardingReady &&
    !hasPortfolio &&
    location.pathname !== "/app/portfolios";
        ...
        >
          ...
          <div className="border-t border-sidebar-border p-3">
            <Button
              ...
              size="sm"
              className={cn(
                "w-full gap-2 border-sidebar-border bg-sidebar-accent/40",
                collapsed && "px-0",
              )}
            ...
            >
              {collapsed ? (
                ...
                <>
                  <PanelRightClose className="h-4 w-4" /> جمع کردن منو
                </>
              )}
            </Button>
          </div>
