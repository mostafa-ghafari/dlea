...
import { V as useAchievements } from "./api-CQV86vH5.mjs";
import { t as Badge } from "./badge-DHlcf1ty.mjs";
import { C as Shield, Et as CircleCheck, Ft as Calendar, K as Lock, Nt as ChartColumn, Rt as Brain, Z as Link2, _ as Swords, _t as DollarSign, at as Heart, b as Star, c as Trophy, d as TrendingDown, g as Target, t as Zap, zt as BookOpen } from "../_libs/lucide-react.mjs";
import { t as AppShell } from "./AppShell-Cx40ixlT.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app.achievements-Cjpa-Kz5.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: achievements.map((a) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: `card-surface group p-6 text-center transition-all hover:scale-[1.02] ${a.earned ? "hover:shadow-lg hover:border-primary/30" : "opacity-50 grayscale hover:grayscale-0 hover:opacity-80"}`,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: `mx-auto grid h-16 w-16 place-items-center rounded-2xl transition-transform group-hover:scale-110 ${a.earned ? `${style.bgGradient} shadow-lg` : style.bgLocked}`,
							children: a.earned ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "h-7 w-7 drop-shadow-sm" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "h-6 w-6" })
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
							variant: "outline",
							className: `mt-4 ${a.earned ? style.badgeClass : "border-border text-muted-foreground"}`,
